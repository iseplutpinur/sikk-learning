...
$(function () {
    ...
    function uploadImage(image, id) {
        ...
        $.ajax({
            url: "<?= base_url()?>about/lainLain/uploadImage",
            cache: false,
            contentType: false,
            processData: false,
            data: data,
    ...
    function deleteFile(name, id) {
        $.LoadingOverlay("show");
        $.ajax({
            url: "<?= base_url()?>about/lainLain/deleteImage",
            data: {
                name: name
            },
            type: "post",
    ...
    // simpan lain lain
    $("#form-lain-lain").submit(function (ev) {
        ev.preventDefault();
        $.LoadingOverlay("show");
        $.ajax({
            url: "<?= base_url()?>about/lainLain/insert",
            data: {
                ...
                gambar: Array.from(lain_lain_image)
            },
            type: "post",
            success: function (data) {
                Toast.fire({
